...
func (r *Repository) GetCloudTenant(ctx context.Context, params GetCloudTenantParams) (CloudTenant, error) {
	return r.db.GetCloudTenant(ctx, params)
}
...
func (r *Repository) CreateOrUpdateCloudTenant(ctx context.Context, input CreateOrUpdateCloudTenantParams) (CloudTenant, error) {
	return r.db.CreateOrUpdateCloudTenant(ctx, input)
}

func (r *Repository) CreateOrUpdateCloudAccount(
	ctx context.Context,
	input CreateOrUpdateCloudAccountParams,
) (CloudAccount, error) {
	return r.db.CreateOrUpdateCloudAccount(ctx, input)
}
