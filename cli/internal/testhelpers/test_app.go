...
func (t *TestRepository) CreateOrUpdateCloudAccount(ctx context.Context, input db2.CreateOrUpdateCloudAccountParams) (db2.CloudAccount, error) {
	args := t.Called(ctx, input)

	return args.Get(0).(db2.CloudAccount), args.Error(1)
}

func (t *TestRepository) GetCloudTenant(ctx context.Context, params db2.GetCloudTenantParams) (db2.CloudTenant, error) {
	args := t.Called(ctx, params)

	return args.Get(0).(db2.CloudTenant), args.Error(1)
}

func (t *TestRepository) CreateOrUpdateCloudTenant(ctx context.Context, input db2.CreateOrUpdateCloudTenantParams) (db2.CloudTenant, error) {
	args := t.Called(ctx, input)

	return args.Get(0).(db2.CloudTenant), args.Error(1)
}

func (t *TestRepository) OrganizationalUnitsCloudAccounts(ctx context.Context, id []uuid.UUID) ([]db2.CloudAccount, error) {
	args := t.Called(ctx, id)

	return args.Get(0).([]db2.CloudAccount), args.Error(1)
}

func (t *TestRepository) GetUserOrganizationalUnits(ctx context.Context, id uuid.UUID) ([]db2.OrganizationalUnit, error) {
	args := t.Called(ctx, id)

	return args.Get(0).([]db2.OrganizationalUnit), args.Error(1)
}

func (t *TestRepository) GetAPIKeysOrganizationalUnits(ctx context.Context, id uuid.UUID) ([]db2.OrganizationalUnit, error) {
	args := t.Called(ctx, id)
...
func (t *TestRepository) CreateTag(ctx context.Context, input db2.CreateTagParams) (db2.StandardTag, error) {
	args := t.Called(ctx, input)

	return args.Get(0).(db2.StandardTag), args.Error(1)
}

func (t *TestRepository) UpdateTag(ctx context.Context, input db2.UpdateTagParams) (db2.StandardTag, error) {
	args := t.Called(ctx, input)

	return args.Get(0).(db2.StandardTag), args.Error(1)
}

func (t *TestRepository) FindTag(ctx context.Context, id uuid.UUID) (db2.StandardTag, error) {
	args := t.Called(ctx, id)

	return args.Get(0).(db2.StandardTag), args.Error(1)
}

func (t *TestRepository) GetTags(ctx context.Context) ([]db2.StandardTag, error) {
	args := t.Called(ctx)

	return args.Get(0).([]db2.StandardTag), args.Error(1)
}

func (t *TestRepository) CreateOrganizationalUnit(ctx context.Context, input db2.CreateOrganizationalUnitParams) (db2.OrganizationalUnit, error) {
	args := t.Called(ctx, input)

	return args.Get(0).(db2.OrganizationalUnit), args.Error(1)
}

func (t *TestRepository) GetOrganizationalUnits(ctx context.Context) ([]db2.OrganizationalUnit, error) {
	args := t.Called(ctx)

	return args.Get(0).([]db2.OrganizationalUnit), args.Error(1)
}

func (t *TestRepository) FindOrganizationalUnit(ctx context.Context, id uuid.UUID) (db2.OrganizationalUnit, error) {
	args := t.Called(ctx, id)

	return args.Get(0).(db2.OrganizationalUnit), args.Error(1)
}

func (t *TestRepository) GetOrganizationalUnitChildren(ctx context.Context, id uuid.UUID) ([]db2.OrganizationalUnit, error) {
	args := t.Called(ctx, id)

	return args.Get(0).([]db2.OrganizationalUnit), args.Error(1)
}

func (t *TestRepository) GetOrganizationalUnitCloudAccounts(ctx context.Context, id uuid.UUID) ([]db2.CloudAccount, error) {
	args := t.Called(ctx, id)
...
func (t *TestRepository) GetAPIKeys(ctx context.Context) ([]db2.ApiKey, error) {
	args := t.Called(ctx)

	return args.Get(0).([]db2.ApiKey), args.Error(1)
}

func (t *TestRepository) CreateAPIKey(ctx context.Context, input db2.InsertAPIKeyParams) (db2.ApiKey, error) {
	args := t.Called(ctx, input)

	return args.Get(0).(db2.ApiKey), args.Error(1)
}

func (t *TestRepository) FindAPIKey(ctx context.Context, id uuid.UUID) (db2.ApiKey, error) {
	args := t.Called(ctx, id)

	return args.Get(0).(db2.ApiKey), args.Error(1)
}

func (t *TestRepository) GetAuditLogs(ctx context.Context) ([]db2.AuditLog, []any, error) {
	args := t.Called(ctx)

	return args.Get(0).([]db2.AuditLog), args.Get(1).([]any), args.Error(1)
}

func (t *TestRepository) GetAuditLogsForTarget(ctx context.Context, input db2.GetAuditLogsForTargetParams) ([]db2.AuditLog, []any, error) {
	args := t.Called(ctx, input)

	return args.Get(0).([]db2.AuditLog), args.Get(1).([]any), args.Error(2)
}

func (t *TestRepository) InsertScimAPIKey(ctx context.Context, encodedHash string) (db2.ApiKey, error) {
...
func (t *TestRepository) FindScimAPIKey(ctx context.Context) (db2.ApiKey, error) {
	args := t.Called(ctx)

	return args.Get(0).(db2.ApiKey), args.Error(1)
}

func (t *TestRepository) GetUsers(ctx context.Context, input db2.GetUsersParams) ([]db2.User, error) {
	args := t.Called(ctx, input)

	return args.Get(0).([]db2.User), args.Error(1)
}

func (t *TestRepository) CreateAuditLog(ctx context.Context, input db2.CreateAuditLogParams) (db2.AuditLog, error) {
	args := t.Called(ctx, input)

	return args.Get(0).(db2.AuditLog), args.Error(1)
}

func (t *TestRepository) UpdateCloudAccountTagsDriftDetected(
	ctx context.Context,
	input db2.UpdateCloudAccountTagsDriftDetectedParams,
) error {
	args := t.Called(ctx, input)
...
func (t *TestRepository) GetScimUsers(ctx context.Context, input db2.GetScimUsersInput) (int64, []db2.User, error) {
	args := t.Called(ctx, input)

	return args.Get(0).(int64), args.Get(1).([]db2.User), args.Error(2)
}

func (t *TestRepository) CreateUser(ctx context.Context, input db2.CreateUserParams) (db2.User, error) {
	args := t.Called(ctx, input)
...
func (t *TestRepository) UpdateUser(ctx context.Context, id uuid.UUID, input db2.UpdateUserParams) (db2.User, error) {
	args := t.Called(ctx, id, input)

	return args.Get(0).(db2.User), args.Error(1)
}

func (t *TestRepository) ScimPatchUser(ctx context.Context, input db2.PatchUserParams) error {
	args := t.Called(ctx, input)

	return args.Error(0)
}

func (t *TestRepository) Begin(ctx context.Context) (db2.RepositoryQueries, error) {
	args := t.Called(ctx)

	return args.Get(0).(db2.RepositoryQueries), args.Error(1)
}
...
func (t *TestRepository) GetCloudTenants(ctx context.Context) ([]db2.CloudTenant, error) {
	args := t.Called(ctx)

	return args.Get(0).([]db2.CloudTenant), args.Error(1)
}

func (t *TestRepository) FindGroup(ctx context.Context, id string) (db2.Group, error) {
	args := t.Called(ctx, id)

	return args.Get(0).(db2.Group), args.Error(1)
}

func (t *TestRepository) CreateGroup(ctx context.Context, displayName string) (db2.Group, error) {
...
func (t *TestRepository) UpdateGroup(ctx context.Context, input db2.PatchGroupDisplayNameParams) (db2.Group, error) {
	args := t.Called(ctx, input)
...
func (t *TestRepository) GetGroupMembership(ctx context.Context, idString string) ([]db2.GetGroupMembershipRow, error) {
	args := t.Called(ctx, idString)

	return args.Get(0).([]db2.GetGroupMembershipRow), args.Error(1)
}

func (t *TestRepository) GetGroups(ctx context.Context, params db2.GetGroupsParams) (int64, []db2.Group, error) {
	args := t.Called(ctx, params)

	return args.Get(0).(int64), args.Get(1).([]db2.Group), args.Error(2)
}

func (t *TestRepository) FindUser(ctx context.Context, id string) (db2.User, error) {
	args := t.Called(ctx, id)
...
func (t *TestRepository) FindCloudAccount(
	ctx context.Context,
	input db2.FindCloudAccountInput,
) (db2.CloudAccount, error) {
	args := t.Called(ctx, input)
...
func (t *TestRepository) UpdateCloudAccount(
	ctx context.Context,
	input db2.UpdateCloudAccountParams,
) (db2.CloudAccount, error) {
	args := t.Called(ctx, input)
...
func (t *TestRepository) FindUserByUsername(ctx context.Context, username string) (db2.User, error) {
...
func (t *TestRepository) SearchCloudAccounts(
	ctx context.Context,
	input db2.SearchCloudAccountsInput,
) ([]db2.CloudAccount, error) {
	args := t.Called(ctx, input)
